module.exports = class Data1671031271379 {
    name = 'Data1671031271379'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "contract" ("id" character varying NOT NULL, "name" text NOT NULL, "symbol" text NOT NULL, "total_supply" numeric NOT NULL, CONSTRAINT "PK_17c3a89f58a2997276084e706e8" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_973644690f8ec06af4eebfd3a8" ON "contract" ("name") `)
        await db.query(`CREATE TABLE "token" ("id" character varying NOT NULL, "name" text, "image_uri" text, "uri" text, "expires" numeric NOT NULL, "owner_id" character varying, "contract_id" character varying, CONSTRAINT "PK_82fae97f905930df5d62a702fc9" PRIMARY KEY ("id"))`)
